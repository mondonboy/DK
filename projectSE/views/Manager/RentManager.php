        ...
        <div class="w3-green w3-container w3-card w3-margin-bottom">
            ...
            <nav class=" w3-green  w3-large " style="z-index:3;font-weight:bold;" ><br>
                ...
                <div class="w3-bar-block">
                    ...
                    <a href="EditTypeManager.php" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white w3-margin"><i class="fa fa-list fa-fw w3-margin-right w3-large w3-text-white"></i>แสดงหมวดหมู่</a>
    ...
    <div class="w3-white w3-container w3-card w3-margin-bottom">
        <form method="get" action="">
            ...
            <div class="w3-container w3-padding">
                ...
                $header = array("ชื่ออุปกรณ์","หมวดหมู่","เลขครุภัณฑ์55555","สถานะ","");
                $data = array();
                $i = 0;
