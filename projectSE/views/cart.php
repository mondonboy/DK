    ...
    <div class="w3-white w3-container w3-card w3-margin-bottom">
        <form method="get" action="">
            ...
            <div class="w3-container w3-padding" style="margin: 10px">
                ...
                <a href="" class="w3-right">เพิ่มอุปกรณ์</a>
            </div>
            ...
            <div class="w3-container w3-padding">
                ...
                $data[0] = array("5","6","7","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[1] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[2] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[3] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[4] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[5] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[6] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[7] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[8] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[9] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[10] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
                $data[11] = array("7","8","9","<button>เพิ่มลงตะกร้า</button>","<button>แก้ไข</button>","<button>ลบ</button>");
