                ...
                <form method="get" action="">
                    <div class="w3-container w3-middle" >
                        ...
                        <div class="w3-row w3-margin">
                            ...
                            <div class="w3-center">
                                <a href="ListRequestAdmin.php"><label class="w3-button w3-green w3-round-large">อนุมัติ</label></a>
                                <label class="w3-button w3-red w3-round-large" onclick="document.getElementById('Edit').style.display='block'">ไม่อนุมัติ</label>
    ...
    <div id="Edit" class="w3-modal">
        ...
        <span onclick="document.getElementById('Edit').style.display='none'"
            ...
            <div class="w3-container">
                ...
                <a href="ListRequestAdmin.php" ><button class="w3-button w3-block w3-teal w3-padding-16 w3-section w3-right" onclick="document.getElementById('Edit').style.display='none'">ตกลง <i class="fa fa-check"></i></button>
